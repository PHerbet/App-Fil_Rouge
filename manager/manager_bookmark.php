<?php
    ...
    class ManagerBookmark extends Bookmark {
        ...
        {//instanciation of a new object
            ...
            try
            {//SQL request
                $req = $bdd->prepare('INSERT INTO bookmark(name_bookmark, url_bookmark, description_bookmark, img_bookmark)
                VALUES (:name_bookmark, :url_bookmark, :description_bookmark, :img_bookmark )');
                $req -> execute(array(
                    'name_bookmark' => $name,
                    'url_bookmark' => $url,
